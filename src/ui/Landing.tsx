...
export default function Landing({ onHelp, onPrefs }: { onHelp: () => void; onPrefs: () => void }) {
    ...
    >
      ...
      >
        <span className="relative flex h-24 w-24 items-center justify-center transition-transform duration-500 ease-out group-hover/orb:scale-105 group-active/orb:scale-95">
          ...
          <span
            className="absolute inset-0 rounded-full border border-brand-500/40 animate-orb-ripple"
          ...
          <span
            className={`absolute inset-2 rounded-full border border-brand-500/25 animate-orb-drift ${dragging ? 'border-brand-400/60' : ''}`}
          />
          {/* breathing core */}
          <span className="animate-orb-breathe">
            ...
            >
              <svg
                ...
                height="24"
                viewBox="0 0 24 24"
                className="transition-transform duration-300 group-hover/orb:-translate-y-0.5"
              >
                {dragging ? (
                  <path
                    d="M12 16V4m-5 5 5-5 5 5M5 16v2a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2v-2"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="1.9"
                    strokeLinecap="round"
