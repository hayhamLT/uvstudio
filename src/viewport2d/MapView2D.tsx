...
function Scene({
  ...
  return (
    <group>
      ...
      {/* highlight of the chunk the selected screen uses within the full PSD */}
      {chunkGeom && (
        <lineSegments geometry={chunkGeom} renderOrder={5}>
          <lineBasicMaterial color="#5cc8ff" transparent opacity={0.9} depthTest={false} />
        </lineSegments>
      )}
